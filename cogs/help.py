...
class Help(commands.Cog):
    ...
    async def help(self, ctx, page=None):
        ...
        if not page or not page in pages:
            ...
            embed.set_author(icon_url=ctx.me.avatar.with_format('png'), name="Restaurant Help Manual")
            ...
            embed.set_author(icon_url=ctx.me.avatar.with_format('png'), name="Restaurant Help Manual | Page 1")
            ...
            embed.set_author(icon_url=ctx.me.avatar.with_format('png'), name="Restaurant Help Manual | Page 2")
            embed.set_image(url="http://paixlukee.dev/m/FGGUC.png")
            embed.set_footer(text="Arguments are inside [] and <>. [] is optional and <> is required. Do not include [] or <> in the command.")
            await ctx.send(embed=embed)
        elif page == 3:
            ...
            embed.set_author(icon_url=ctx.me.avatar.with_format('png'), name="Restaurant Help Manual | Page 3")
            embed.set_image(url="http://paixlukee.dev/m/FGGUC.png")
            embed.set_footer(text="Arguments are inside [] and <>. [] is optional and <> is required. Do not include [] or <> in the command.")
            await ctx.send(embed=embed)
        elif page == 4:
            ...
            embed.set_author(icon_url=ctx.me.avatar.with_format('png'), name="Restaurant Help Manual | Page 4")
